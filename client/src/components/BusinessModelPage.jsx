        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
              <p>
                TalentHub bridges the gap between clients looking for talent
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    TalentHub charges a flat 10% service fee per project to
                    keep the platform running and ensure secure transactions.
                  </span>
                </li>
              </ul>
              <p className="mt-8">
                From creative design to software development, TalentHub is your
              ...
              <p className="mt-6">
                We’re more than a marketplace. TalentHub fosters a community of

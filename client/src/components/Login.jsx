      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full rounded-md border border-gray-300 p-2.5 text-sm text-gray-900 focus:border-[#40A2C9] focus:ring-[#40A2C9]"
            required
          />
        </div>
        ...
        <motion.button
          type="submit"
          className="w-full rounded-md bg-[#40A2C9] px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-[#40A2C9]"
